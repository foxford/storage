...
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/storage/ns/_/storage.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/storage/ns/_/storage-service.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/storage/ns/${NAMESPACE}/storage-config.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/storage/ns/${NAMESPACE}/storage-environment.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/storage/ns/${NAMESPACE}/storage-ingress.yaml"
